...
public class Main {
    ...
    CommandLineRunner runner(
        ...
        return args -> {
            ...
            //testBucketYploadAndDownload(s3Service, s3Buckets);
        };
    }

    private static void testBucketYploadAndDownload(S3Service s3Service, S3Buckets s3Buckets) {
        s3Service.putObject(s3Buckets.getCustomer(),
                "foo/bar/testingfolder",
